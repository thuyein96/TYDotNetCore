...
using TYDotNetCore.PizzaApi.Db;
using TYDotNetCore.PizzaApi.Queries;
using TYDotNetCore.Shared;

namespace TYDotNetCore.PizzaApi.Features.Pizza
{
    ...
    public class PizzaController : ControllerBase
    {
        ...
        {
            var item = _dapperService.FirstOrDefaultQuery<PizzaOrderInvoiceHeadModel>
                (
